...
// function renderDateAndTime(launches) {
//   const ul = document.querySelector("launch_date_local");
//   for (let launch of launches) {
//     ul.append(dateAndTime(launch.launch_date_local))
//   }
// }

// function dateAndTime(launch_date_local) {
//   const newLI = document.createElement('LI');
//   const launchDate = document.createElement('B');
//   launchDate.innerText = launch_date_local;
//   newLI.append(launchDate);
//   newLI.innerHTML += ` - ${launch.rocket.rocket_name}`
//   return newLI;
// }
